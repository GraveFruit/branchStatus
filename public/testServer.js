function testServer(json, url){
    this.json = json;
    this.url = url;

    this.defaultUrl = function () {
        this.url= "http://localhost:8080/testServerJson.json"
    }

    this.defaultJson = function () {
        this.json =  [{
    ...
    this.randomize = function (quantity){
        for(var i = 0; i<quantity; i++){
            var currentNumber = Math.floor(Math.random()*this.getLength());
